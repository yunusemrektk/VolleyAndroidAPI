...
public class WeatherDataService {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for(int i = 0; i<consolidated_weather_list.length();i++){
                                ...
                                one_day_weather.setPredictablity(first_day_from_api.getInt("predictability"));
    ...
    public void getCityForecasetByName(String cityName, final GetCityForecastByNameCallBack getCityForecastByNameCallBack) {
